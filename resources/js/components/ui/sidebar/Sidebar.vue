...
import { SidebarProps } from '@/components/ui/sidebar/index';
...
<template>
  ...
  >
    ...
    >
      <div
        data-sidebar="sidebar"
        class="bg-sidebar flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm transition-colors duration-300"
      >
        <slot />
      </div>
    </div>
