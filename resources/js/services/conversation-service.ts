...
export const conversationService = {
  ...
  async getList(params?: {
    ...
    return baseResponseApi(
      () => conversationAPI.getList(params),
      $t('common.fetchConversationsError'),
    );
  },
  ...
  async getByID(conversationId: number): Promise<ApiResponse<any>> {
    return baseResponseApi(
      ...
      $t('common.fetchConversationError'),
    );
  },
  ...
  async create(data: {
    ...
    return baseResponseApi(
      ...
      $t('common.createConversationError'),
    );
  },
  ...
  async update(conversationId: number, data: Partial<Conversation>): Promise<ApiResponse<any>> {
    return baseResponseApi(
      () => conversationAPI.update(conversationId, data),
      $t('common.updateConversationError'),
    );
  },
  ...
  async delete(conversationId: number): Promise<ApiResponse<any>> {
    return baseResponseApi(
      ...
      $t('common.deleteConversationError'),
    );
  },
  ...
  async restore(conversationId: number): Promise<ApiResponse<any>> {
    return baseResponseApi(
      ...
      $t('common.restoreConversationError'),
    );
  },
  ...
  async getMembers(conversationId: number): Promise<ApiResponse<any>> {
    return baseResponseApi(
      () => conversationAPI.getMembers(conversationId),
      $t('common.fetchConversationMembersError'),
    );
  },
  ...
  async addMember(
    ...
    return baseResponseApi(
      () => conversationAPI.addMember(conversationId, data),
      $t('common.addMemberError'),
    );
  },
  ...
  async removeMember(conversationId: number, data: { user_id: number }): Promise<ApiResponse<any>> {
    return baseResponseApi(
      () => conversationAPI.removeMember(conversationId, data),
      $t('common.removeMemberError'),
    );
  },
  ...
  async getMyConversations(params?: {
    ...
    return baseResponseApi(
      () => conversationAPI.getMyConversations(params),
      $t('common.fetchMyConversationsError'),
    );
  },
  ...
  async pin(conversationId: number): Promise<ApiResponse<any>> {
    return baseResponseApi(
      () => conversationAPI.pin(conversationId),
      $t('common.pinConversationError'),
    );
  },
  ...
  async mute(conversationId: number, minutes?: number): Promise<ApiResponse<any>> {
    return baseResponseApi(
      () => conversationAPI.mute(conversationId, { minutes }),
      $t('common.muteConversationError'),
    );
  },
  ...
  async unmute(conversationId: number): Promise<ApiResponse<any>> {
    return baseResponseApi(
      ...
      $t('common.unmuteConversationError'),
    );
  },
  ...
  async getSettings(conversationId: number): Promise<ApiResponse<any>> {
    return baseResponseApi(
      () => conversationAPI.getSettings(conversationId),
      $t('common.fetchConversationSettingsError'),
    );
  },
  ...
  async updateSettings(
    conversationId: number,
    data: Partial<ConversationSetting>,
  ): Promise<ApiResponse<any>> {
    return baseResponseApi(
      () => conversationAPI.updateSettings(conversationId, data),
      $t('common.updateConversationSettingsError'),
    );
  },
  ...
  async markMessagesAsDelivered(conversationId: number): Promise<ApiResponse<any>> {
    return baseResponseApi(
      () => conversationAPI.markMessagesAsDelivered(conversationId),
      $t('common.markMessagesAsDeliveredError'),
    );
  },
  ...
  async markAllMessagesAsDelivered(): Promise<ApiResponse<any>> {
    return baseResponseApi(
      () => conversationAPI.markAllMessagesAsDelivered(),
      $t('common.markAllMessagesAsDeliveredError'),
    );
  },
  ...
  async markMessagesAsSeen(conversationId: number): Promise<ApiResponse<any>> {
    return baseResponseApi(
      () => conversationAPI.markMessagesAsSeen(conversationId),
      $t('common.markMessagesAsSeenError'),
    );
  },
};
