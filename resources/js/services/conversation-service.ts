...
export const conversationService = {
   ...
   */
  async getList(params?: { type?: 'direct' | 'group'; search?: string; page?: number }): Promise<ApiResponse<any>> {
   ...
   */
  async getMyConversations(params?: { page?: number; type?: 'direct' | 'group' }): Promise<ApiResponse<any>> {
    return baseResponseApi(
