<template>
  <SidebarProvider>
    ...
    <SidebarInset class="h-[calc(100vh-0.1rem)] w-[calc(100%-48px)] transition-colors duration-300 overflow-y-auto">
      ...
      <div class="bg-[#FAFAFA] dark:bg-[#171717] w-full h-full overflow-auto transition-colors duration-300">
        <RouterView />
      </div>
    </SidebarInset>
  </SidebarProvider>
...
import { Contact, Home, Moon, Sun } from 'lucide-vue-next';
...
const data: NavItem[] = [
  ...
  { title: 'common.messages', routeName: APP_ROUTE_NAME.USER.MESSAGES, icon: Contact },
];
